...
## Figure 45｜Hon 財務預測摘要

![Figure 45](../assets/20260528_Citi_7769-HonPrecision/exhibit_45.png)

### 解讀摘要
完整 P&L 顯示 Hon 在 2025-28E 間的獲利能力結構轉型：毛利率從 56.5% 升至 61.1%，淨利率從 42.4% 升至 45.5%，每股盈餘從 NT\$171 跳升至 NT\$379，三年 EPS CAGR 約 30%（以 2025 為基數）或以 Citi 2026E 為起點的兩年 CAGR 約 76%。

### 表格（來自 Citi 財務模型）

| 指標（NT\$mn） | 2026E | 2027E | 2028E |
|---|---|---|---|
| 營收 | 51,615 | 88,350 | 149,816 |
| 毛利 | 29,749 | 52,476 | 91,509 |
| 營業利益 | 26,545 | 47,723 | 84,656 |
| 淨利 | 21,988 | 38,856 | 68,127 |
| EPS（NT\$） | 122.22 | 215.98 | 378.69 |
| 毛利率 | 57.6% | 59.4% | 61.1% |
| 營業利益率 | 51.4% | 54.0% | 56.5% |
| 淨利率 | 42.6% | 44.0% | 45.5% |

---

## Figure 46｜Citi vs. 市場共識估計

![Figure 46](../assets/20260528_Citi_7769-HonPrecision/exhibit_46.png)

### 解讀摘要
Citi 在 2026E 幾乎與市場共識持平（EPS -2%），但到 2027-28E 的分歧持續擴大。最大分歧點是 2028E 的營業利益率：Citi 估 56.5% vs. 共識 51.7%，差距達 +4.8ppt。這個差異背後的假設是：Citi 預期 Tri-temp handler 的 ASP 升級和 cold plates 消耗品比例提升，將在 2027-28 年帶來市場低估的毛利率擴張。若此假設正確，2028E 的 EPS 實現可能超出共識 +9%。

### 表格

| 指標 | 2026E Citi | 2026E Con. | 差 | 2027E Citi | 2027E Con. | 差 | 2028E Citi | 2028E Con. | 差 |
|---|---|---|---|---|---|---|---|---|---|
| 營收（NT\$mn） | 51,615 | 51,831 | 0% | 88,350 | 85,434 | +3% | 149,816 | 142,558 | +5% |
| 毛利（NT\$mn） | 29,749 | 29,668 | 0% | 52,476 | 49,801 | +5% | 91,509 | 85,672 | +7% |
| 營業利益（NT\$mn） | 26,545 | 26,290 | +1% | 47,723 | 45,862 | +4% | 84,656 | 73,768 | +15% |
| 淨利（NT\$mn） | 21,988 | 21,702 | +1% | 38,856 | 37,405 | +4% | 68,127 | 63,262 | +8% |
| EPS（NT\$） | 122.22 | 124.66 | -2% | 215.98 | 204.70 | +6% | 378.69 | 347.38 | +9% |
| 毛利率 | 57.6% | 57.2% | +0.4ppt | 59.4% | 58.3% | +1.1ppt | 61.1% | 60.1% | +1.0ppt |
| 營業利益率 | 51.4% | 50.7% | +0.7ppt | 54.0% | 53.7% | +0.3ppt | 56.5% | 51.7% | **+4.8ppt** |
| 淨利率 | 42.6% | 41.9% | +0.7ppt | 44.0% | 43.8% | +0.2ppt | 45.5% | 44.4% | +1.1ppt |

> **洞察一**：2028E 營業利益率差距 4.8ppt 是整份報告最具 contra-consensus 意義的數字。背後是 Citi 對 ASP 升級速度的不同假設——共識可能低估了 Tri-temp handler 滲透和 cold plates 消耗品比例提升的複合效應。
> **值得驗證**：Citi 的 2028E 毛利率 61.1% 是否可達，最關鍵的驗證點是 2026-27 年間 Tri-temp handler 實際滲透速度（圖 34 的 ATC5.X 量產時程）。若 Tri-temp 滲透晚一年，2028E 毛利率可能落在 58-59%，接近共識。
