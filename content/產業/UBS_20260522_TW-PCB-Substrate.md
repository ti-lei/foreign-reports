...
| 需求結構 | Fig 1–3 | 前五大 Hyperscaler 2026/27E capex +61%/+14% 至 US\$719/819bn；CPU TAM 2030E 成長 5x 至 US\$170bn |
...
### 解讀摘要
前五大 Hyperscaler（Meta、Amazon、Microsoft、Alphabet、Oracle）2026/27E 合計 capex 將達 US\$719/US\$819bn（+61%/+14% YoY），「AI 動能持續」已從財測轉為資本配置的確定訊號。Capex-to-sales 比率在 2026E 達 36.1%，遠高於 2024A 的 17.6%，意味著整個雲端基礎設施投資仍在加速，而非趨緩。

### 表格（年度摘要）

| 指標 | 2024A | 2025A | 2026E |
|---|---|---|---|
| 前五大合計 Capex/Sales | 17.6% | 26.5% | 36.1% |
| YoY 成長 | — | +51% | +61% |

> **原文補充**：UBS 引用 Tim Arcuri 的 GPU 出貨預測：2025A 5.7MM → 2026E 9.0MM → 2027E 9.9MM（+57%/+10% YoY）；agentic 部署每位用戶 CPU core 需求為傳統的 3–5x。

> **洞察一**：Capex 加速的組合（GPU 數量 × per-GPU substrate content 增加）是雙乘效應——Unimicron 和 Kinsus 承受的是 volume × ASP 同步上行，不是其中一項。
