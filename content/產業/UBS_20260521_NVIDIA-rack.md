...
| 論點層次 | Figure | 內容 |
|---|---|---|
| 需求信號：供應鏈承諾 +299% YoY | 1 | 購買承諾 $119bn；中國禁售（$4.55bn，5.6%）完全不影響承諾成長動能 |
| 財務超預期：資料中心 +92% YoY | 2 | FQ127 $81.6bn 超街頭 $78.9bn；新段落揭示 ACIE QoQ 成長超越 Hyperscale |
| 資本支出上修：$916/$1,088bn | 3 | 全球超大規模業者本季再上修 9%/18%；2027E 更大上修幅度 |
| Rack 預測上修：+16%/+8% | 4 | ODM 實際拉貨驅動上修；2026 62.5k→72.5k；AI GPU 8.7mn→10.3mn |
| 貨幣化加速：雲端 +47/+51% YoY | 5 | OCF $1.155trn > Capex $1.088trn；不需舉債即可支應 |
...
供應鏈購買承諾在中國出口受限下仍達 $119bn（+299% YoY / +25% QoQ），承諾增速遠超超大規模業者 capex 增速（+74% YoY），說明 NVIDIA 正透過長期鎖倉策略控制供應鏈上游。中國收入從峰值 $9.66bn（FQ1Q26，21.9% of sales）縮減至 $4.55bn（FQ1Q27，5.6%），年減 -52.9%，但購買承諾完全不受影響——說明非中國市場需求已足以填補並超越缺口。庫存天數穩定在 115 天（FY26 = 115.4，FQ127 = 115.4），絕對值 +20% QoQ 至 $25.8bn，是「規模擴大型庫存」而非需求堆積。

> **原文補充**：FQ227 指引明確不含任何 H200 中國銷售；NVIDIA 庫存承諾（製造 + 供應 + 產能）在 FY27 年度內的 $95bn 佔總承諾 $119bn 的 80%，代表近期 12 個月的可見度極高。
...
> **洞察二**：中國收入 FQ127 = $4.55bn（-52.9% YoY），相當於 FQ1Q26 峰值的 47%，即超過 $5bn 的季度需求被禁住。當前 UBS 模型不含任何 H200 中國恢復——這部分是純選擇權，不是基本假設，一旦政策轉向將是即時正面催化劑。
...
FQ127（2026 年 4 月）NVIDIA 總收入 $81.6bn，超出街頭預期 $78.9bn，毛利率 75% 符合預期。本季最重要的新資訊是 NVIDIA 首次揭露段落拆分：資料中心拆為 Hyperscale $37.9bn（+12% QoQ / +115% YoY）與 ACIE（AI Cloud / 工業 / 企業）$37.4bn（+31% QoQ / +74% YoY），兩者規模幾乎對等。ACIE 的 QoQ 成長（+31%）快於 Hyperscale（+12%），說明需求端已多元化；Networking +199% YoY 至 $14.8bn 則是最高增速的業務，毛利也較高，是 GM 擴張的隱藏驅動力。

> **原文補充**：Rubin 效能相對 Blackwell 具備「35x 更高 inference / 10x 收益提升」的優勢，是換代主因。FQ227 指引 $91bn ±2%，明確不含 H200 中國銷售；中國超大規模業者銷售從 22%（FY1Q26）降至 6%（FQ1Q27）。管理層確認 Sovereigns 成長 +80% YoY，主權 AI 需求成為新的增量來源。

### 表格

**NVIDIA FQ127 實際結果 vs. 指引**

| 項目 | FQ127 實際 | 街頭預期 | 超出幅度 | FQ227 指引 |
|---|---|---|---|---|
| 總淨銷售 | $81.6bn | $78.9bn | +$2.7bn | $91bn ±2% |
| 資料中心 | $75.2bn | $73.1bn | +$2.1bn | — |
| 　Compute | $60.4bn (+77% YoY) | — | — | — |
| 　Networking | $14.8bn (+199% YoY) | — | — | — |
| 毛利率 | 75% | — | 符合 | 75%（維持） |
...
| 新段落 | FQ127 | QoQ | YoY |
|---|---|---|---|
| Hyperscale（超大規模雲端） | $37.9bn | +12% | +115% |
| ACIE（AI Cloud / 工業 / 企業） | $37.4bn | +31% | +74% |
| Edge Computing（PC / 車用 / 機器人 / 自動駕駛） | $6.4bn | +10% | +29% |

**中國銷售（HQ 所在地）趨勢**

| 時點 | 金額 | 佔銷售比重 |
|---|---|---|
| FY1Q26 (Apr'25) | $9.66bn | 21.9% |
| FY2026 (年) | $19.68bn | 9.1% |
| FQ1Q27 (Apr'26) | $4.55bn（-53% YoY / +49% QoQ） | 5.6% |

### 洞察

> **洞察一**：ACIE QoQ 成長（+31%）超越 Hyperscale（+12%），且兩者體量幾乎一致（$37.9bn vs. $37.4bn）。NVIDIA 的需求端已不再高度集中於 4-5 家超大規模業者，未來訂單波動性可能降低；對 Nvidia 股票而言，這是週期風險緩解的正面訊號。

> **洞察二**：Networking $14.8bn（+199% YoY）已接近 FY25 全年資料中心規模，且毛利高於 GPU 硬體。市場 EPS 模型若沒有對 Networking 毛利溢價建模，則對 Nvidia GM 可能存在系統性低估。
...
本季全球 20 家超大規模業者與 neocloud 全數完成財報，UBS 將 2026/27E capex 上修 9%/18%，總量達 $916bn/$1,088bn（+74%/+19% YoY）。2027E 上修幅度（+18%）是 2026E（+9%）的兩倍，表示市場對中長期需求的確信度正在強化。Top 5 美國超大規模業者（Meta / Google / Amazon / Microsoft / Oracle）合計 2026/27E capex 為 $789bn/$947bn，佔全部超大規模業者 capex 的 86%/87%。Coreweave / xAI 等 neocloud 成長最快（YoY 數百%），但體量仍遠小於 Top 5。

> **原文補充**：Internet service revenue 本季上修 +1%/+5% for 2026-27E，達 +17%/+16% YoY 至 $2.67trn（2027E）。UBS 指出若 OCF 維持 +32% YoY 成長，capex 成長可在不大量舉債的情況下持續至 +40% YoY，這是維持超大規模業者現金流健康的安全邊界。
...
UBS 用這張圖反駁「capex bubble」論點：超大規模業者的貨幣化（雲端部門成長）正在每年加速，而非見頂。美國雲端業務（AWS / Azure / GCP）收入成長從 2024-25 年 +24/+29% 加速至 2026-27E +47/+51%，OCF 預計 2026/27 各 +32% YoY 至 $1.155trn，覆蓋率超過 capex（$1.088trn），不需大量舉債即可支應。中國網路公司（Baidu / Alibaba / Tencent）收入也在修復，新增一層非美國市場的佐證。

> **原文補充**：本季 Internet service revenue 上修 +1%/+5% for 2026-27E，至 2027E +16% YoY，達 $2.67trn。主要超大規模業者淨現金穩定在 $436bn（2026 年），顯示財務健全度高，不存在短期債務壓力。
...
| Internet service 總收入成長 | — | +17% YoY | +16% YoY（$2.67trn） |
| 合計 Capex（全部超大規模業者） | $527bn | $916bn (+74%) | $1,088bn (+19%) |
| 合計 OCF（主要超大規模業者） | — | — | $1.155trn (+32% YoY) |
| OCF / Capex 覆蓋率 | — | — | ~106% |
| 主要超大規模業者淨現金 | — | $436bn（穩定） | — |

### 洞察

> **洞察一**：OCF $1.155trn > Capex $1.088trn，覆蓋率 ~106%，表示超大規模業者整體在不舉債的情況下仍可支應 2027E 全部 capex，且仍有 ~$67bn FCF 餘裕。「capex bubble」論點需要否定這個現金流數字，而不是只看 capex 絕對值。
