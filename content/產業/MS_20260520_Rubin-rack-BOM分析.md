...
<a href="#" onclick="fetch('https://ti-lei.github.io/foreign-reports/static/downloads/產業/MS_20260520_Rubin-rack-BOM分析.md').then(r=>r.blob()).then(b=>{let a=document.createElement('a');a.href=URL.createObjectURL(b);a.download='MS_20260520_Rubin-rack-BOM分析.md';a.click()});return false">⬇ 下載 MD</a>
...
|---|---|---|---|---|
| ODM（首選） | 緯穎 | 6669.TW | OW | Top Pick |
| ODM | 緯創 | 3231.TW | OW | 估值最便宜 |
| ODM | 廣達 | 2382.TW | OW | AI 佔比最高 |
| ODM | 鴻海 | 2317.TW | OW | |
| PCB | 欣興 | 3037.TW | OW | |
| PCB | 臻鼎（ZDT） | 4958.TW | OW | |
| 電源 | 台達電 | 2308.TW | OW | HVDC 關鍵受益 |
| 散熱 | 奇鋐（AVC） | 3017.TW | OW | Tray manifold |
| MLCC | 國巨 | 2327.TW | OW | |
